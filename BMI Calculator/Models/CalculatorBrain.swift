...
//  BMI Calculator
//
//  Created by Ivan Kopych on 18.11.2020.
...
struct CalculatorBrain {
    ...
    mutating func calculateBMI(height: Float, weight: Float ) {
        let bmiCalculate = weight / pow(height, 2)
        
        let bmiValue = bmiCalculate
        ...
        if bmiValue < 18.5 {
            ...
            bmi = BMI(value: bmiValue, advice: "Eat less pice!" , color: #colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 1))
        }
